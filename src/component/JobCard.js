...
function JobCard(props) {
  ...
  var job = props.job;
  return (
    <div className="shadow-sm grid-span-1 bg-white rounded-md  pb-7 static my-8 font-sans ">
      <div className="relative  -inset-y-6 place-content-end flex justify-between items-end">
        ...
        <div className="uppercase text-primary font-semibold relative text-sm top-0 right-0 h-12 w-30 hover:bg-gray-100 cursor-pointer px-6 py-10">
      ...
      <div className="px-5">
        ...
        <div className="text-xl font-bold  py-6">{job.title}</div>
        <div className="text-caption text-base">{job.company}</div>
